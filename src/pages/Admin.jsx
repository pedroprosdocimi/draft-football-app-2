...
const STAT_LABELS = {
  ...
  saves_outsidebox:         'Defesas fora da área',
  clean_sheet:              'Jogo sem gol',
...
const STAT_COLS = [
  ...
  'total_crosses','accurate_crosses','crosses_missed','accurate_crosses_pct',
  'passes','passes_missed','accurate_passes','accurate_passes_pct','key_passes',
  'long_balls','long_balls_won','long_balls_missed','long_balls_won_pct',
  ...
  'tackles','tackles_won','tackles_missed','tackles_won_pct',
  'interceptions','clearances','blocked_shots',
  'fouls','fouls_drawn',
  'touches','ball_recovery','possession_lost',
  'saves','saves_insidebox','saves_outsidebox','clean_sheet','goals_conceded','goalkeeper_goals_conceded',
...
export default function Admin({ onBack }) {
  ...
  const [chartOnlyPlayed, setChartOnlyPlayed] = useState(true);
      ...
      <div className="card mb-6">
        ...
        <div className="flex flex-wrap gap-4 mb-4 items-end">
          ...
          <label className="flex items-center gap-2 cursor-pointer self-end mb-1">
            <input
              type="checkbox"
              checked={chartOnlyPlayed}
              onChange={e => setChartOnlyPlayed(e.target.checked)}
              className="accent-draft-green w-4 h-4"
            />
            <span className="text-sm text-gray-300">Apenas com minutos jogados</span>
          </label>
